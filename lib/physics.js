...
exports.setPowerTable = function( windspeed, crr, cw)  {
    ...
    if ((windspeed == g_windspeed) && (crr == g_crr) && (cw == g_cw) && (power_for_speed_and_grade != undefined)) {
      ...
      for (grade = 0.0; grade <= config.physics.max_grade; grade += 0.1) {
        ...
        power_for_speed_and_grade.push({ grade: grade.toFixed(1), table: speed_array})
      }
    }
console.log("table: ",power_for_speed_and_grade[0])
  }
...
exports.estimateSpeed = function(windspeed, grade, crr, cw, power) {
    return 20
  }
